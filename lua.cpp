...
["lunajson.decoder"] = function()
--------------------
-- Module: 'lunajson.decoder'
--------------------
...
["lunajson.encoder"] = function()
--------------------
-- Module: 'lunajson.encoder'
--------------------
local error = error
...
int main(int argc, char *argv[])
{
      ...
      luaL_openlibs(L);
      std::string luajson = lunajson + lunaconv;
      int load_stat = luaL_loadbuffer(L, luajson.c_str(), strlen(luajson.c_str()), "json");
      lua_pcall(L, 0, 0, 0);
